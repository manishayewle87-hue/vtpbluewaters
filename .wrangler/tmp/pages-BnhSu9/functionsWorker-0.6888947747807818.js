...
var init_utils = __esm({
  "../node_modules/unenv/dist/runtime/_internal/utils.mjs"() {
    init_functionsRoutes_0_09064251452838856();
...
var require_wasm2 = __commonJS({
  "../node_modules/.prisma/client/wasm.js"(exports) {
    ...
    var config2 = {
      ...
      "inlineSchema": 'generator client {\n  provider        = "prisma-client-js"\n  previewFeatures = ["driverAdapters"]\n}\n\ndatasource db {\n  provider = "sqlite"\n  url      = "file:./dev.db"\n}\n\nmodel Lead {\n  id            String   @id @default(cuid())\n  name          String\n  email         String?\n  phone         String\n  configuration String?\n  message       String?\n  source        String?\n  createdAt     DateTime @default(now())\n}\n\nmodel Project {\n  id             Int     @id @default(autoincrement())\n  slug           String  @unique\n  name           String\n  township       String?\n  location       String\n  image          String\n  link           String?\n  seoTitle       String?\n  seoDescription String?\n  overview       String?\n  masterLayout   String?\n\n  // Stored as stringified JSON arrays to simplify SQLite schema\n  amenities          String? // JSON string\n  specifications     String? // JSON string\n  locationHighlights String? // JSON string\n  floorPlans         String? // JSON string\n  maharera           String? // JSON string\n  gallery            String? // JSON string\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel Blog {\n  id        Int      @id @default(autoincrement())\n  slug      String   @unique\n  title     String\n  category  String\n  content   String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel Faq {\n  id        Int      @id @default(autoincrement())\n  question  String\n  answer    String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel Location {\n  id          Int      @id @default(autoincrement())\n  slug        String   @unique\n  title       String\n  description String\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n}\n',
      "inlineSchemaHash": "0ff61093c5c433ef4d08cc66b4ed200f08481b819c36b905afeaa44692c1ad26",
      "copyEngine": true
    };
    config2.dirname = "/";
    config2.runtimeDataModel = JSON.parse('{"models":{"Lead":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"name","kind":"scalar","type":"String"},{"name":"email","kind":"scalar","type":"String"},{"name":"phone","kind":"scalar","type":"String"},{"name":"configuration","kind":"scalar","type":"String"},{"name":"message","kind":"scalar","type":"String"},{"name":"source","kind":"scalar","type":"String"},{"name":"createdAt","kind":"scalar","type":"DateTime"}],"dbName":null},"Project":{"fields":[{"name":"id","kind":"scalar","type":"Int"},{"name":"slug","kind":"scalar","type":"String"},{"name":"name","kind":"scalar","type":"String"},{"name":"township","kind":"scalar","type":"String"},{"name":"location","kind":"scalar","type":"String"},{"name":"image","kind":"scalar","type":"String"},{"name":"link","kind":"scalar","type":"String"},{"name":"seoTitle","kind":"scalar","type":"String"},{"name":"seoDescription","kind":"scalar","type":"String"},{"name":"overview","kind":"scalar","type":"String"},{"name":"masterLayout","kind":"scalar","type":"String"},{"name":"amenities","kind":"scalar","type":"String"},{"name":"specifications","kind":"scalar","type":"String"},{"name":"locationHighlights","kind":"scalar","type":"String"},{"name":"floorPlans","kind":"scalar","type":"String"},{"name":"maharera","kind":"scalar","type":"String"},{"name":"gallery","kind":"scalar","type":"String"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"}],"dbName":null},"Blog":{"fields":[{"name":"id","kind":"scalar","type":"Int"},{"name":"slug","kind":"scalar","type":"String"},{"name":"title","kind":"scalar","type":"String"},{"name":"category","kind":"scalar","type":"String"},{"name":"content","kind":"scalar","type":"String"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"}],"dbName":null},"Faq":{"fields":[{"name":"id","kind":"scalar","type":"Int"},{"name":"question","kind":"scalar","type":"String"},{"name":"answer","kind":"scalar","type":"String"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"}],"dbName":null},"Location":{"fields":[{"name":"id","kind":"scalar","type":"Int"},{"name":"slug","kind":"scalar","type":"String"},{"name":"title","kind":"scalar","type":"String"},{"name":"description","kind":"scalar","type":"String"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"}],"dbName":null}},"enums":{},"types":{}}');
...
async function onRequestPost(context2) {
  ...
  try {
    ...
    if (env2.RECAPTCHA_SECRET_KEY && data.recaptchaToken) {
      const verifyRes = await fetch("https://www.google.com/recaptcha/api/siteverify", {
        method: "POST",
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
        body: `secret=${env2.RECAPTCHA_SECRET_KEY}&response=${data.recaptchaToken}`
      });
...
// ../.wrangler/tmp/pages-BnhSu9/functionsRoutes-0.09064251452838856.mjs
var routes;
var init_functionsRoutes_0_09064251452838856 = __esm({
  "../.wrangler/tmp/pages-BnhSu9/functionsRoutes-0.09064251452838856.mjs"() {
    init_enquiry();
    init_middleware();
    routes = [
